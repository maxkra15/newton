...
- Add an SDF-backed five-speed VBD tablecloth-trick example with interactive pull-speed controls
- Add a unified AVBD/VBD H1 tablecloth example with Newton IK hand targets, full-body robot-cloth contact, fine finger-mesh SDFs, and adjustable pull acceleration
