...
#
# Command:
#   uv run -m newton.examples cable_robot_proxy_coupled_solver
#   uv run newton/examples/cable_robot/example_cable_robot_proxy_coupled_solver.py
#
###########################################################################
...
from newton.solvers.experimental.coupled import SolverCoupledProxy as SolverProxyCoupled
...
# Cable robot assets live next to this example.
...
if not HOSE_CONNECTOR_PATH.is_file():
    HOSE_CONNECTOR_PATH = ASSETS_ROOT / "connector.stl"
