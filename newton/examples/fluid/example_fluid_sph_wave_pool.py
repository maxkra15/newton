...
class Example:
    ...
    def create_parser():
        ...
        parser.add_argument("--dim-x", type=int, default=134)
        parser.add_argument("--dim-y", type=int, default=54)
        parser.add_argument("--dim-z", type=int, default=16)
        parser.add_argument("--spacing", type=float, default=0.024)
        ...
        parser.add_argument("--smoothing-length", type=float, default=0.0516)
        ...
        parser.add_argument("--paddle-amplitude", type=float, default=0.24)
        ...
        parser.add_argument("--fluid-blur-radius", type=float, default=0.06)
        parser.add_argument("--foam-color", type=float, nargs=4, default=(0.9, 0.95, 1.0, 1.6))
        parser.add_argument("--foam-radius", type=float, default=0.013)
